                    ...
                    <div className="modal-box">
                        <form onSubmit={handleSubmit(onSubmit)} method="dialog">
                            ...
                            <div className='mt-4 space-y-2'>
                                <span>Name</span>
                                <br />
                                <input type='text' placeholder='Enter your name' className='w-80 px-3 py-1 border rounded-md outline-none' {...register("full_name", { required: true })} />
                                <br />
                            ...
                            <div className='flex justify-around mt-4'>
                                ...
                                <p className='text-xl'>
                                    Have account? <Link to = "/login" className='underline text-blue-500 cursor-pointer'>Login</Link>
                                </p>
                            </div>
                        </form>
                    </div>
