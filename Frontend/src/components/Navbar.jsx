...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl conatainer mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 right-0 left-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out" : ""
                }`}>
                <div className="navbar">
                    <div className="navbar-start">
                        ...
                        <Link to="/">
                            <a className="text-2xl font-bold cursor-pointer">Art Gallery</a>
                        </Link>
                    </div>
